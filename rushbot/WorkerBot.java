...
public class WorkerBot extends Bot{
	...
	public void assignTarget(){
	    ...
	    if(dest==null){//blueprint factory
	    	if(gc.karbonite()>400||(logs.statistics().get("Factory")<4&&gc.karbonite()>bc.bcUnitTypeBlueprintCost(UnitType.Factory))) {
	    		//build up to 4 factories when available or more depending on available karbonite
